...
# Determine data/model directories from environment or use defaults
DATA_DIR = os.getenv("DATA_INPUT_DIR", "/app/data")
MODEL_DIR = os.getenv("MODEL_OUTPUT_DIR", "/app/models")

VECTOR_PATH       = os.path.join(DATA_DIR, "processed", "tfidf_vectorizer.pkl")
MODEL_PATH        = os.path.join(MODEL_DIR, "sgd_text_model.pkl")
PRODUCT_DICT_PATH = os.path.join(MODEL_DIR, "product_dictionary.pkl")
